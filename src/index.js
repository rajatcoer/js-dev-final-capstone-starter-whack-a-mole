...
function showAndHide(hole, delay){
  // Called the toggleVisibility function so that it adds the 'show' class.
  toggleVisibility(hole);
  const timeoutID = setTimeout(() => {
    // Called the toggleVisibility function so that it removes the 'show' class when the timer times out.
    toggleVisibility(hole);
    gameOver();
...
function toggleVisibility(hole){
  // Added hole.classList.toggle() so that it adds or removes the show class.
